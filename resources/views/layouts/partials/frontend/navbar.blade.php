        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <a href="{{ url('/') }}" class="d-flex justify-content-center gap-2"
                        style="text-decoration: none">
                        <span class="mdi mdi-cart text-light"></span>
                        ...
                        @if (Auth::check() && Auth::user()->role == 'admin')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin/dashboard') }}">
                                    <span class="mdi mdi-monitor-dashboard"></span> Dashboard
                                </a>
                            </li>
                        @endif
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li>
                                        <a class="dropdown-item" href="{{ Route('profile') }}"><i class="fa fa-user"></i>
                                            Profile</a>
                                    </li>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/#trending-products') }}">New Products</a>
                    </li>
                    <li class="nav-item">
