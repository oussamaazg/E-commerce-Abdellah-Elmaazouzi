...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">E-Commerce</h2>
                </th>
    ...
    <table>
        ...
        <tbody>
            ...
            @forelse ($order->orderItems as $orderItem)
                <tr>
                    <td widith="10%">{{ $orderItem->id }}</td>
                    <td> {{ $orderItem->product->name }}</td>
                    <td widith="10%"> ${{ $orderItem->price }}</td>
                    <td widith="10%">{{ $orderItem->quantity }}</td>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Our E-Commerce WebSite
    </p>
