        ...
        <div class="container">
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel"
                                                ...
                                                <hr />
                                                <button wire:click="sendOrder" wire:loading.attr="disabled" type="button" class="btn btn-primary">
                                                    <span wire:loading.remove wire:target="sendOrder">Place Order (Cash on Delivery)</span>
                                                    <span wire:loading wire:target="sendOrder">Placing Order ...</span>
                                                </button>
                                            </div>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    ...
                    <a href="{{ url('collections') }}" class="btn btn-warning text-light">Shop Now</a>
                </div>
            @endif
        </div>
    </div>
