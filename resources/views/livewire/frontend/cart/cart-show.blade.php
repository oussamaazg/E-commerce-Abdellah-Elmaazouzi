                ...
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        @forelse ($cart as $cartItem)
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        <div class="col-md-6 my-auto">
                                            <a
                                                href="{{ url('collections/' . $cartItem->product->category->name . '/' . $cartItem->product->slug) }}">
                                        ...
                                        <div class="col-md-2 col-7 my-auto">
                                            <div class="quantity">
                                                <div class="input-group">
                                                    ...
                                                    <input type="button" value="{{ $cartItem->quantity }}"
                            ...
                            @endif
                        @empty
                            <div class="alert alert-info">No Cart Items available</div>
                        @endforelse
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total:
                            <span class="fload-end">${{ $totalPrice }}</span>
                        </h4>
                        <hr>
